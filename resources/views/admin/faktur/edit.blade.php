                    ...
                    <table class="admin-table">
                        ...
                        @foreach ($faktur->items as $item)
                            <tr>
                                ...
                                @if ($item->product)
                                    <td>
                                        <img src="{{ $item->product->app_type == 1 ? 'https://tokobayifiv.com/public/uploads/'. $item->product->image : 'https://babynesia.com/public/uploads/' . $item->product->image }}" class="h-vh-10 mx-auto">
                                    </td>
