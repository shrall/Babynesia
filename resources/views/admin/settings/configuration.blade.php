    ...
    <form action="{{ route('adminpage.webconfig.store') }}" method="post">
        ...
        <div class="w-full flex flex-col gap-y-4 p-4">
            <div class="admin-card">
                ...
                <div class="col-span-7">{{
                array_values($webconfigs->where("name", "title")->toArray())[0]["content"] }}</div>
                ...
                <div class="col-span-7">{{
                array_values($webconfigs->where("name", "end_date")->toArray())[0]["content"] }}</div>
            </div>
            <div class="admin-card">
                ...
                <div class="col-span-7 flex items-center gap-x-2">
                    <input type="text" name="company_name" id="company_name" class="admin-input"
                        value="{{
                        array_values($webconfigs->where("name", "company_name")->toArray())[0]["content"] }}">
                </div>
                <div class="col-span-5">Nomor Whatsapp</div>
                <div class="col-span-7 flex items-center gap-x-2">
                    <input type="text" name="client_hp" id="client_hp" class="admin-input" placeholder="WAJIB DALAM FORMAT 62XXXXXXXXX"
                        value="{{
