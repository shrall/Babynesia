                ...
                <div class="col-span-6 flex flex-col items-center justify-center gap-2 px-12">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="radio" name="web_layout" value="1" id="layout-1"
                            {{ $webconfigs[38]->content == '1' ? 'checked' : '' }}>
                ...
                <div class="col-span-6 flex flex-col items-center justify-center gap-2 px-12">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="radio" name="web_layout" value="2" id="layout-2"
                            {{ $webconfigs[38]->content == '2' ? 'checked' : '' }}>
                ...
                <div class="col-span-12 flex flex-col gap-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <label for="button-color-red-400" id="label-button-color-red-400"
                            ...
                            class="w-4 h-4 bg-red-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'red' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-orange-400" class="hidden"
                            value="orange" {{ $webconfigs[37]->content == 'orange' ? 'checked' : '' }}>
                        <label for="button-color-orange-400" id="label-button-color-orange-400"
                            ...
                            class="w-4 h-4 bg-orange-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'orange' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-amber-400" class="hidden"
                            value="amber" {{ $webconfigs[37]->content == 'amber' ? 'checked' : '' }}>
                        <label for="button-color-amber-400" id="label-button-color-amber-400"
                            onclick="changeColor('button-color-amber-400', 'button_color');"
                            class="w-4 h-4 bg-amber-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'amber' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-yellow-400" class="hidden"
                            value="yellow" {{ $webconfigs[37]->content == 'yellow' ? 'checked' : '' }}>
                        <label for="button-color-yellow-400" id="label-button-color-yellow-400"
                            ...
                            class="w-4 h-4 bg-yellow-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'yellow' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-lime-400" class="hidden"
                            value="lime" {{ $webconfigs[37]->content == 'lime' ? 'checked' : '' }}>
                        <label for="button-color-lime-400" id="label-button-color-lime-400"
                            onclick="changeColor('button-color-lime-400', 'button_color');"
                            class="w-4 h-4 bg-lime-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'lime' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-green-400" class="hidden"
                            value="green" {{ $webconfigs[37]->content == 'green' ? 'checked' : '' }}>
                        <label for="button-color-green-400" id="label-button-color-green-400"
                            onclick="changeColor('button-color-green-400', 'button_color');"
                            class="w-4 h-4 bg-green-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'green' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-emerald-400" class="hidden"
                            value="emerald" {{ $webconfigs[37]->content == 'emerald' ? 'checked' : '' }}>
                        <label for="button-color-emerald-400" id="label-button-color-emerald-400"
                            ...
                            class="w-4 h-4 bg-emerald-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'emerald' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-teal-400" class="hidden"
                            value="teal" {{ $webconfigs[37]->content == 'teal' ? 'checked' : '' }}>
                        <label for="button-color-teal-400" id="label-button-color-teal-400"
                            onclick="changeColor('button-color-teal-400', 'button_color');"
                            class="w-4 h-4 bg-teal-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'teal' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-cyan-400" class="hidden"
                            value="cyan" {{ $webconfigs[37]->content == 'cyan' ? 'checked' : '' }}>
                        <label for="button-color-cyan-400" id="label-button-color-cyan-400"
                            onclick="changeColor('button-color-cyan-400', 'button_color');"
                            class="w-4 h-4 bg-cyan-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'cyan' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-sky-400" class="hidden"
                            value="sky" {{ $webconfigs[37]->content == 'for="bg-color-sky-400" id=' ? 'checked' : '' }}>
                        <label for="button-color-sky-400" id="label-button-color-sky-400"
                            onclick="changeColor('button-color-sky-400', 'button_color');"
                            class="w-4 h-4 bg-sky-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'sky' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-blue-400" class="hidden"
                            value="blue" {{ $webconfigs[37]->content == 'blue' ? 'checked' : '' }}>
                        <label for="button-color-blue-400" id="label-button-color-blue-400"
                            onclick="changeColor('button-color-blue-400', 'button_color');"
                            class="w-4 h-4 bg-blue-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'blue' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-indigo-400" class="hidden"
                            value="indigo" {{ $webconfigs[37]->content == 'indigo' ? 'checked' : '' }}>
                        <label for="button-color-indigo-400" id="label-button-color-indigo-400"
                            ...
                            class="w-4 h-4 bg-indigo-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'indigo' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-violet-400" class="hidden"
                            value="violet" {{ $webconfigs[37]->content == 'violet' ? 'checked' : '' }}>
                        <label for="button-color-violet-400" id="label-button-color-violet-400"
                            ...
                            class="w-4 h-4 bg-violet-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'violet' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-purple-400" class="hidden"
                            value="purple" {{ $webconfigs[37]->content == 'purple' ? 'checked' : '' }}>
                        <label for="button-color-purple-400" id="label-button-color-purple-400"
                            ...
                            class="w-4 h-4 bg-purple-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'purple' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-fuchsia-400" class="hidden"
                            value="fuchsia" {{ $webconfigs[37]->content == 'fuchsia' ? 'checked' : '' }}>
                        <label for="button-color-fuchsia-400" id="label-button-color-fuchsia-400"
                            ...
                            class="w-4 h-4 bg-fuchsia-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'fuchsia' ? 'border-slate-600' : '' }}">
                        </label>
                        <input type="radio" name="button_color" id="button-color-pink-400" class="hidden"
                            value="pink" {{ $webconfigs[37]->content == 'pink' ? 'checked' : '' }}>
                        <label for="button-color-pink-400" id="label-button-color-pink-400"
                            onclick="changeColor('button-color-pink-400', 'button_color');"
                            class="w-4 h-4 bg-pink-400 border hover:border-slate-600 cursor-pointer button_color {{ $webconfigs[37]->content == 'pink' ? 'border-slate-600' : '' }}">
                        </label>
                    </div>
                </div>
            </div>
