...
@section('content')
    ...
    <div class="container mx-auto xl:px-32 px-3 xl:pt-6 xl:pb-10 pt-3 pb-5">
                    ...
                    <div class="hidden sm:block border-l-2 border-gray-100 pl-4">
                        <div class="flex items-center">
                            ...
                            <button type="submit" form="updatecart{{ $cart->no_detail_cart }}"
                                class="ml-2 bg-{{ $color[2] }}-400 hover:bg-{{ $color[2] }}-500 focus:ring-{{ $color[2] }}-300 rounded-md py-1 px-2 text-center text-sm sm:text-base text-white font-encode-sans font-bold">
        ...
        <div class="w-full bg-white rounded-md shadow-sm mt-3 px-3 py-5">
            ...
            <div>
                <input id="voucher" form="checkVoucher" placeholder="Masukkan kode voucher" type="text" value="{{ $voucher != null ? $voucher->code : null }}"
                class="appearance-none border-b-2 p-1 mt-2 w-1/4" name="voucher">
    
                <button type="submit" form="checkVoucher"
                    class="ml-2 bg-{{ $color[2] }}-400 hover:bg-{{ $color[2] }}-500 focus:ring-{{ $color[1] }}-300 rounded-md py-1 px-2 text-center text-sm sm:text-base text-white font-encode-sans font-bold">
            ...
            <form action="{{ route('user.receiver.create') }}" method="get">
                ...
                <div class="xl:flex xl:items-start">
                    <div class="w-full bg-white rounded-md shadow-sm mt-3 px-3 py-5 xl:w-8/10">
                        ...
                        <textarea name="note" id="catatan-tambahan" placeholder="Masukkan catatan tambahan"
                            class="mt-2 py-1 px-2 appearance-none border-2 w-full"></textarea>
                    ...
                    <div class="ml-3 hidden xl:block">
                        ...
                        <div class="text-center mt-4">
                            <a href="/"
                                class="w-full bg-gray-300 hover:bg-gray-400 hover:text-gray-300 font-bold font-encode-sans text-white px-4 py-2 rounded-full">
                                Lanjutkan Belanja
                            </a>
                        </div>
                    </div>
