...
@section('content')
    ...
    <div class="container mx-auto xl:px-32 px-3 xl:pt-6 xl:pb-10 pt-3 pb-5">
                                ...
                                <div>
                                    ...
                                    @if ($cart->produk->stat == 'd')
                                        <p class="font-encode-sans text-sm text-gray-400">
                                            <del>Rp.
                                                {{ substr(number_format($cart->produk->harga, 2, ',', '.'), 0, -3) }}</del>
                                        </p>
                                    @endif
        ...
        <div class="w-full bg-white rounded-md shadow-sm mt-3 px-3 pt-3 pb-7 xl:px-4">
            ...
            <div class="mt-3 p-2 border-2 text-sm sm:text-base font-encode-sans text-slate-900">
        ...
        <div class="w-full bg-white rounded-md shadow-sm mt-3 px-3 py-3 xl:px-4">
            ...
            <table class="table-auto w-full mb-5 mt-3">
                ...
                <tfoot class="bg-neutral-100 font-bold font-encode-sans text-slate-900">
                    <tr>
                ...
                <div class="hidden xl:block">
                    <div class="w-full text-center mt-3">
                        <button type="submit" id="finish1" disabled
                            class="w-full bg-{{ $color[2] }}-400 hover:bg-{{ $color[2] }}-500 text-white font-bold font-encode-sans px-8 py-2 rounded-full disabled:text-gray-400 disabled:bg-neutral-300">
                            Finish
                        </button>
                    </div>
