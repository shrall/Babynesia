    ...
    <div class="w-full bg-white rounded-md shadow-sm mt-3 px-3 pt-3 pb-5">
        ...
        <div class="sm:flex sm:justify-between">
            ...
            <div class="hidden sm:block border-l-2 border-gray-100 pl-4 w-40">
                ...
                <button type="submit" form="updatecart" class="appearance-none hover:text-{{ $color[2] }}-400 text-slate-900 mt-4 xl:mt-8 flex items-center">
    ...
    <div class="relative bg-white rounded-lg shadow">
        ...
        <div class="p-5 rounded-t border-b">
            <div class="flex justify-between items-start">
                <h3 class="text-3xl sm:text-4xl font-concert-one text-{{ $color[1] }}-500">
            ...
            <form action="{{ route('user.detailcart.update', $cart) }}" method="post">
                ...
                <div>
                    ...
                    <input name="jumlah" id="jumlah{{ $cart->no_detail_cart }}" type="number"
                        ...
                        class="border-{{ $color[1] }}-500 border appearance-none w-full rounded-lg p-1 text-slate-900 font-encode-sans">
                </div>
                <div class="mt-3">
                    <div>
                        <label for="note{{ $cart->no_detail_cart }}"
                    ...
                    <textarea name="note" id="note{{ $cart->no_detail_cart }}" cols="20" required
                        class="border-{{ $color[1] }}-500 border appearance-none w-full rounded-lg p-1 text-slate-900 font-encode-sans">{{ $cart->note }}</textarea>
                    <button type="submit"
