...
class Faktur extends Model
{
    ...
    protected $fillable = [
        ...
        'deliveryDate', 'deliveryExpedition', 'deliveryResi', 'tanggal2', 'discount', 'note', 'admin_note', 'total_weight', 'sender_name', 'sender_phone', 'sender_address', 'voucher_id', 'app_type', 'product_type'
    ];
