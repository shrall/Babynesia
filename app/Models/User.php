...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'no_user', 'email', 'password', 'name', 'lastname',
        'alamat', 'kota', 'propinsi', 'negara', 'kodepos', 'telp',
        'hp', 'birthday', 'gender', 'noKTP', 'stat', 'tgl_gabung', 'conf', 'user_status_id', 'kecamatan', 'app_type'
    ];
